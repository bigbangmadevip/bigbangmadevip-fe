...
type DialogStepConfig = {
  title: string;
  description: (context: CheeringDialogContext) => ReactNode;
  buttonLabel: string;
};
...
function getCompleteDescription(typeCompletedCount: number, message: string) {
  return (
    <>
      현재 <strong className="font-bold">{typeCompletedCount}명</strong>의 VIP가
      <br />
      {message}
    </>
  );
...
export const CHEERING_DIALOG_CONFIG = {
  STREAMING: {
    ...
    complete: {
      ...
      description: ({ typeCompletedCount }) =>
        getCompleteDescription(typeCompletedCount, '스트리밍을 함께 했어요.'),
      buttonLabel: '확인',
    },
  },
  ...
  DOWNLOAD: {
    ...
    complete: {
      title: '음원 다운로드 완료!',
      description: ({ typeCompletedCount }) =>
        getCompleteDescription(typeCompletedCount, '다운로드를 함께 했어요.'),
      buttonLabel: '확인',
    },
  },
  ...
  PREVOTE: {
    ...
    complete: {
      title: '오늘의 투표 완료!',
      description: ({ typeCompletedCount }) =>
        getCompleteDescription(typeCompletedCount, '투표를 함께했어요.'),
      buttonLabel: '확인',
    },
  },
  ...
  VOTECOIN: {
    ...
    complete: {
      title: '투표권 사용 완료!',
      description: ({ typeCompletedCount }) =>
        getCompleteDescription(typeCompletedCount, '투표권을 함께 모았어요.'),
      buttonLabel: '확인',
    },
  },
